...
class Day18Test {
  ...
  void testSolvePart1() {
    ...
    assertThat(Day18.solvePart1(resource)).isEqualTo(3_699L);
  }
  ...
  void testSolvePart2Example() {
    ...
    assertThat(Day18.solvePart2(example)).isEqualTo(157);
  }
  ...
  void testSolvePart2() {
    ...
    assertThat(Day18.solvePart2(resource)).isEqualTo(157);
  }
}
